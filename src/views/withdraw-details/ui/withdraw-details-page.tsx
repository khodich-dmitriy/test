...
const WithdrawTicketChat = dynamic(
  () => import('@/src/features/support/chat/ui/withdraw-ticket-chat').then((mod) => mod.WithdrawTicketChat),
  {
    ssr: false,
    loading: () => <p className={styles.chatLoading}>Loading chat...</p>
  }
);
